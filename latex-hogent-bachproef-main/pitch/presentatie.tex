...
\begin{document}
    ...
    \begin{frame}
        \frametitle{1. Probleemschets: De kost van downtime}
            \begin{itemize}
                ...
                \item \textbf{Financiële Impact:} Downtime kost \textbf{90\%} van de bedrijven ruim \textbf{\$300.000 per uur}; bij 41\% loopt dit op van \textbf{\$1 tot over \$5 miljoen} \parencite{ITIC2024}.
                \item \textbf{Verborgen Kosten:} Serveruitval leidt niet alleen tot operationele verliezen, maar ook tot zware reputatieschade, waarbij \textbf{20\% tot 40\%} van de schade al ontstaat door onzekerheid over de exacte impact \parencite{Kollective2025}.
                \item \textbf{De Cloud-Architectuur:} Fencing vereist verplichte uitgaande connectiviteit naar publieke endpoints, en Azure Scheduled Events dwingen tot het gebruik van een specifieke cloud-agent om onderbrekingen te voorkomen \parencite{Microsoft2026}.
            \end{itemize}
    \end{frame}
        ...
        \begin{columns}[c]
            ...
            \begin{block}{Core Framework}
                \begin{itemize}
                    ...
                    \item \textbf{STONITH:} Fysieke node-fencing voorkomt split-brain en data-corruptie \parencite{Romancik2024}.
                \end{itemize}
            \end{block}
            ...
            \vspace{0.15cm}
            \scriptsize 
            \textbf{Figuur 1:} De architecturale gelaagdheid van de clusterstack, met Corosync als fundament voor de communicatie tussen de hardware nodes \parencite{John2017}.
        \end{columns}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}[c]
            ...
            \vspace{0.15cm}
            \scriptsize 
            \textbf{Figuur 2:} Visuele weergave van het onderzoeksproces \parencite{Gemini2026}.
            
            \column{.55\textwidth}
            \begin{itemize}
                \item \textbf{Fase 1: Baseline PoC-opzet:} Azure provisioning en implementatie van een HA-cluster.
                \item \textbf{Fase 2: Fencing \& Quorum:} Implementatie van STONITH via Managed Identities en quorumbeheer.
        ...
        \begin{table}
            ...
            \resizebox{0.95\textwidth}{!}{%
                \begin{tabular}{llll}
                    ...
                    \midrule
                    \textbf{Linux Kernel} & \texttt{tcp\_retries2} & 15 ($\approx$15m) & \textbf{5} \\
                    & \texttt{tcp\_syn\_retries} & 6 & \textbf{3} \\
                    \midrule
            ...
            \vspace{0.2cm}
            \scriptsize 
            \textbf{Tabel 1:} Vergelijking tussen de baseline en de geoptimaliseerde parameters.
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            ...
            \vspace{0.15cm}
            \scriptsize 
            \textbf{Figuur 3:} Uiteindelijk netwerkschema van de geoptimaliseerde Active-Passive HA-omgeving binnen de Azure Resource Group \parencite{Gemini2026}.
        \end{center}
    \end{frame}
        ...
        \begin{center}
            \begin{minipage}{0.85\textwidth}
                \begin{table}
                    ...
                    \par\vspace{0.2cm}
                    \scriptsize 
                    \textbf{Tabel 2:} Vergelijking van de hersteltijden per uitvalscenario.
                \end{table}
        ...
        \begin{table}
            ...
            \resizebox{0.95\textwidth}{!}{%
                \begin{tabular}{lll}
                    ...
                    \midrule
                    \textbf{Cluster Stack Tuning} & Token gereduceerd naar 500ms & \alert{Risico op false positives} bij netwerkjitter. \\
                    \textbf{Cloud Netwerk Integratie} & Floating IP / DSR geactiveerd & Extra netwerkconfiguratie vereist voor snelle failover. \\
                    \textbf{Split-Brain Preventie} & Azure Power Fencing via API & Data-integriteit zonder shared storage. \\
                    \textbf{Beveiliging} & Managed Identities voor STONITH & Geen credentialbeheer binnen de cluster-stack. \\
                    \bottomrule
                \end{tabular}
            }
            \par\vspace{0.2cm}
            \scriptsize 
            \textbf{Tabel 3:} Synthese van de onderzochte aspecten en bijbehorende trade-offs.
        \end{table}
        \centering
        \vspace{0.1cm}
