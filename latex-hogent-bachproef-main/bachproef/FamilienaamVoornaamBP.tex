...
\title%
    {Optimalisatie van de Recovery Time Objective (RTO) in Active-Passive High Availability Clusters met Pacemaker en Corosync op RHEL-Nodes.}
