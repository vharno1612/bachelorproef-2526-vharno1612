%==============================================================================
% Ultiem Visueel Gecorrigeerd & Horizontaal Uitgelijnd Sjabloon - Arno Verhulst
%==============================================================================
...
% Handige commando's voor visuele 'badges' (leuker voor het oog!)
...
% Centrale en foutloze styling voor de onderzoekskaarten via tcolorbox
...
\cosupervisor{Dhr. D. Allaert (oXya)}

\specialisation{Systeem- en Netwerkbeheer}
\keywords{High Availability, Cloud Gap, Pacemaker, Corosync, RTO-Optimalisatie, Fencing}
\projectrepo{https://github.com/arnoverhulst/bachelorproef}

\begin{document}
    
    % Kleur de volledige achtergrond van de poster
    \pagecolor{posterbg}
    
    \maketitle
    
    % Abstract / Samenvatting als brede kaart over de volledige breedte
    \begin{center}
    ...
    \begin{center}
        \begin{minipage}{0.96\linewidth}
            ...
            \noindent
            % LINKERKOLOM (Nu met: Introductie -> Methodologie -> Parameter Tuning)
            \begin{minipage}[t]{0.489\linewidth}
                \vspace{0pt} % Dwingt de absolute bovenkant van de linkerkolom als uitlijnpunt
                
                % KAART 1: Onderzoeksvragen (Geoptimaliseerd voor ruimte en structuur)
                ...
                % KAART 3: Tuning (Verplaatst van rechts naar links onder de methodologie)
            ...
            \end{minipage}%
            \hfill % Duwt de kolommen strak naar de buitenranden
            % RECHTERKOLOM (Nu met: Architectuur -> Resultaten -> Conclusie)
            \begin{minipage}[t]{0.489\linewidth}
                \vspace{0pt} % Dwingt de absolute bovenkant van de rechterkolom als exact uitlijnpunt
                
                % KAART 4: De Cloud Architectuur (Verplaatst van links naar de top van de rechterkolom)
